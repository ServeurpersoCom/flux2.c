...
static int double_block_forward_cuda(float *img_hidden, float *txt_hidden,
    ...
    /* === Phase 1: AdaLN modulation on CPU (small) === */
    int mod_size = h * 6;
    ...
    flux_linear_nobias(img_mod, t_emb_silu, img_adaln_weight, 1, h, mod_size);
    flux_linear_nobias(txt_mod, t_emb_silu, txt_adaln_weight, 1, h, mod_size);

    float *img_shift1 = img_mod, *img_scale1 = img_mod + h, *img_gate1 = img_mod + h*2;
    float *img_shift2 = img_mod + h*3, *img_scale2 = img_mod + h*4, *img_gate2 = img_mod + h*5;
    float *txt_shift1 = txt_mod, *txt_scale1 = txt_mod + h, *txt_gate1 = txt_mod + h*2;
    float *txt_shift2 = txt_mod + h*3, *txt_scale2 = txt_mod + h*4, *txt_gate2 = txt_mod + h*5;
